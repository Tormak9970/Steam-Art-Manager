<script lang="ts">
  ...
  import { canSave, isOnline, showBatchApplyModal } from "../Stores";
...
<div class="footer">
  ...
  <div class="btns">
    ...
    <IconButton label="View on GitHub" onClick={() => open("https://github.com/Tormak9970/Steam-Art-Manager")} width="auto">
    ...
    <HorizontalSpacer />
    <IconButton label="Reload SARM" onClick={AppController.reload} width="auto">
    ...
    <HorizontalSpacer />
    <IconButton label="Batch Apply" onClick={() => { $showBatchApplyModal = true; }} width="auto" disabled>
    ...
    <HorizontalSpacer />
    <IconButton label="Import" onClick={AppController.importGrids} width="auto">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height: 12px; width: 12px;">
        <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
    ...
    <HorizontalSpacer />
    <IconButton label="Export" onClick={AppController.exportGrids} width="auto">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height: 12px; width: 12px;">
        <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
    ...
    <HorizontalSpacer />
    <IconButton label="Settings" onClick={WindowController.openSettingsWindow} width="auto">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height: 12px; width: 12px;">
        <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
