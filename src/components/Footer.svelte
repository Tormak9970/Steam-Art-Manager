<script lang="ts">
  ...
  import { canSave, isOnline, showAddManualGameModal, showBatchApplyModal } from "../Stores";
...
<div class="footer">
  ...
  <div class="btns">
    ...
    <HorizontalSpacer />
    <IconButton label="Add Games" onClick={() => { $showAddManualGameModal = true; }} width="auto" tooltipPosition="auto">
