...
<div class="grid" on:click="{selectGame}">
  ...
  {#if grid?.isAnimated}
    <div
      class="image-control show-animated"
      use:AppController.tippy="{{
        content: 'Animated',
        placement: 'left',
        onShow: AppController.onTippyShow,
  ...
  {#if grid?.notes}
    <div
      class="image-control show-notes"
      use:AppController.tippy="{{
        content: 'Notes',
        placement: 'right',
        onShow: AppController.onTippyShow,
  ...
  <GridImage
    ...
    missingMessage="Unable to display grid"
