...
<div class="game" class:selected={$selectedGameAppId == game.appid} on:click={selectGame}>
  <div class="image-control show-hide" on:click={isHidden ? unHide : hide} use:AppController.tippy={{ content: isHidden ? "Unhide" : "Hide", placement: "right", onShow: AppController.onTippyShow}}>
    {#if isHidden}
  ...
  <div class="image-control show-discard" on:click={() => { AppController.discardChangesForGame(game.appid); }} use:AppController.tippy={{ content: "Discard Changes", placement: "right", onShow: AppController.onTippyShow}}>
  ...
  <div class="image-control show-clear" on:click={() => { AppController.clearCustomArtForGame(game.appid); }} use:AppController.tippy={{ content: "Clear Art", placement: "right", onShow: AppController.onTippyShow}}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
