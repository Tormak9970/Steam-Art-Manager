...
<div class="context-menu-background">
  <div class="context-menu">
    ...
    {#if $ctxMenuSourceIsImage}
      ...
      <ContextAction label="Save Image As" onClick={saveImageAs} width="100%" marginBottom={IS_DEBUG ? "5px" : "0px"}>
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" style="fill: var(--font-color);">
          <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
    ...
    <!-- svelte-ignore missing-declaration -->
    {#if IS_DEBUG}
      <ContextAction label="Inspect" onClick={inspectElement} width="100%" marginBottom={"0px"}>
